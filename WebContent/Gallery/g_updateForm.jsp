...
<!-- 게시판 -->
<article>
<h1>Gallery Update</h1><br>
<form action="g_updatePro.jsp" name="fr" method="post" enctype="multipart/form-data">
<input type="hidden" name="num" value="<%=num %>">
<input type="hidden" name="pageNum" value="<%=pageNum %>">
<input type="hidden" name="file" value="<%=gb.getFile() %>">
...
if(gb.getFile() == null){
    ...
    %>
    <tr><td>첨부파일</td>
    <td><img src="../upload/<%=gb.getFile() %>" width="140" height="100"><br>
    <input type="file" name="file" style="padding-left: 80px;"></td></tr>
    <%
}
%>
<tr><td>내용</td><td><textarea name="content" rows="10" cols="20"><%=gb.getContent()%></textarea></td></tr>
</table>
<div id="table_search">
